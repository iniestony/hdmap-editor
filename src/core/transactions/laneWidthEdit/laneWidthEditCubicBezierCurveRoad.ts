...
export default class LaneWidthEditCubicBezierCurveRoadTransaction extends LaneWidthEditRawCurveRoadTransaction {
  ...
  commit() {
    ...
    this.scope.emitEvent(InvokeLaneWidthEditCubicBezierCurveRoadEvent, {
      laneId: this.laneId,
    });
