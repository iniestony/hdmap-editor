...
export default class LaneWidthEditTwoStraightLineRoadTransaction extends StandardTransaction {
  ...
  editNewRoadLaneWidth() {
    ...
    this.scope.emitEvent(InvokeLaneWidthEditTwoStraightLineRoadEvent, {
      laneId: this.laneId,
    });
  }
