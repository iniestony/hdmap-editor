...
export default class CatmullAltitudeReformatCatmullSerieRoadTransaction extends StandardTransaction {
  ...
  generateNewKeyInfoFromOldKeyInfo(oldRoadItemKeyInfo: RoadItemKeyInfo) {
    ...
    const rawReflineSeriePoints = this.scope.generateHermiteSerieAlignedNumLineSeriePointsViaCatmullPointsAndCatmullTangents(rawReflineCatmullPoints, rawReflineCatmullTangents, oldRoadItemKeyInfo.referenceLine.seriePoints.length);
  ...
  reformatNewRoad() {
    ...
    this.scope.emitEvent(InvokeReformatCatmullSerieRoadEvent, {
      roadId: roadItemKeyInfo.roadId,
    });
  }
