...
export default class CatmullEditTwoStraightLineRoadTransaction extends StandardTransaction {
  ...
  editNewRoadCatmull() {
    ...
    this.scope.emitEvent(InvokeCatmullEditTwoStraightLineRoadEvent, {
      laneId: this.laneId,
    });
  }
