...
export default class RoadConnectionLaneLineInnerAttributeEditTransaction extends StandardTransaction {
  ...
  constructor(options: Object) {
    ...
    this.roadConnectionLaneLineAttributeEdit = (options as unknown as { roadConnectionLaneLineAttributeEdit: RoadLaneLineAttributeEdit }).roadConnectionLaneLineAttributeEdit;
