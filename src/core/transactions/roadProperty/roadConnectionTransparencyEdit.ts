...
export default class RoadConnectionTransparencyEditTransaction extends StandardTransaction {
  ...
  reformatNewRoad() {
    ...
    this.scope.emitEvent(InvokeRoadConnectionTransparencyEditEvent, {
      roadId: this.roadId,
    });
  }
