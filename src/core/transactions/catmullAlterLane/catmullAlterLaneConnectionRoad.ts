...
export default class CatmullAlterLaneConnectionRoadTransaction extends StandardTransaction {
  ...
  editNewRoadLaneCatmull() {
    ...
    this.scope.emitEvent(InvokeCatmullAlterLaneConnectionRoadEvent, {
      laneId: this.laneId,
    });
  }
