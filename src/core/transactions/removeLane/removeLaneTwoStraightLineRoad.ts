...
export default class RemoveLaneTwoStraightLineRoadTransaction extends StandardTransaction {
  ...
  removeLane() {
    ...
    this.scope.emitEvent(InvokeRemoveLaneTwoStraightLineRoadEvent, {
      roadId: this.roadId,
    });
  }
  ...
  addLane() {
    ...
    this.scope.emitEvent(InvokeAddLaneTwoStraightLineRoadEvent, {
      roadId: this.roadId,
    });
  }
};