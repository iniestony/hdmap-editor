...
export default class CatmullReformatRawCurveRoadTransaction extends StandardTransaction {
  protected scope: ExtendedNamespace;
  protected newRefLineCatmullPoints: Vector3[];
  protected newRefLineCatmullTangents: Vector3[];
  protected roadId: string;
  protected roadCategory: RoadCategory;

  protected roadItem?: RoadItem;
  protected reflinePoints?: Vector3[];
  protected oldRoadItemKeyInfo?: RoadItemKeyInfo;
  protected newRoadItemKeyInfo?: RoadItemKeyInfo;
