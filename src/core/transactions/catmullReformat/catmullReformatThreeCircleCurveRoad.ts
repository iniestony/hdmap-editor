...
export default class CatmullReformatThreeCircleCurveRoadTransaction extends CatmullReformatRawCurveRoadTransaction {
  ...
  commit() {
    ...
    this.scope.emitEvent(InvokeReformatThreeCircleCurveRoadEvent, {
